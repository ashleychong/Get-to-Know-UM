...
export const SENT_RESET_PASSWORD_EMAIL_SUCCESS = "SENT_RESET_PASSWORD_EMAIL_SUCCESS";
export const SENT_RESET_PASSWORD_EMAIL_FAIL = "SENT_RESET_PASSWORD_EMAIL_FAIL";
export const CLEAR_ERROR_AND_MESSAGE = "CLEAR_ERROR_AND_MESSAGE";
...
export const UPDATE_TOPIC_REPORTER_LIST = "UPDATE_TOPIC_REPORTER_LIST";
export const DELETE_TOPIC = "DELETE_TOPIC";
export const FETCH_BY_SEARCH = "FETCH_BY_SEARCH";

export const FETCH_TOPIC_TAGS = "FETCH_TOPIC_TAGS";
export const UPDATE_TOPIC_TAGS = "UPDATE_TOPIC_TAGS";

export const FETCH_POSTS = "FETCH_POSTS";
export const CREATE_POST = "CREATE_POST";
export const UPDATE_POST = "UPDATE_POST";
export const UPDATE_POST_REPORTER_LIST = "UPDATE_POST_REPORTER_LIST";
