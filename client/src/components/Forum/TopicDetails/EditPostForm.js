...
const EditPostForm = ({ topicId, currentPostId, setCurrentPostId, setOpenPopup }) => {
    const post = useSelector((state) => currentPostId ? state.topics.posts[topicId].find((post) => post._id === currentPostId) : null);
